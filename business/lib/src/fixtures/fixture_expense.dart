...
class FixtureExpense {
  ...
  late final expense1 = Expense(
    ...
    tags: BuiltList([_fixTag.tag1, _fixTag.tag2]),
    files: BuiltList(['file1.png'])
  );
  ...
  late final expense2 = Expense(
    ...
    tags: BuiltList([_fixTag.tag2]),
    files: BuiltList(['file2.pdf', 'file3.png'])
  );
  ...
  late final expense3 = Expense(
    ...
    tags: BuiltList([_fixTag.tag1, _fixTag.tag3]),
    files: BuiltList(['file4.jpg']),
  );
}
